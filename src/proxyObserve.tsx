...
import {Memoization, MemoizationOptions, SnapshotGetterMemo} from "./memoize";
...
export type MemoContexts = { [key: string] : Memoization | SnapshotGetterMemo};
export interface Target {
    ...
    __memoizedProps__ : {[index: string] : MemoizationOptions};
